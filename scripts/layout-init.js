...
$(function () {
    $("#tabs-west").tabs({ heightStyle: "fill" }); //fill, auto, content, default
});


$(function () {
    $("#tabs-center").tabs({ heightStyle: "fill" });
});

$(function () {
    $("#tabs-east").tabs({ heightStyle: "fill" }); //fill, auto, content, default
});
...
function layout_init() {
    ...
    outerLayout.addPinBtn("#tbarPinTools", "west");
    outerLayout.addPinBtn("#tbarPinCode", "east");
...
, north: {
    ...
    //, togglerLength_open: 35			// HIDE the toggler button=0
...
, east: {
    ...
    //, initClosed: true - needs ot be open to get code editors to view the right size
